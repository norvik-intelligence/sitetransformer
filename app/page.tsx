...
export default function ScraperHome() {
  ...
  async function scrape() {
    ...
    try {
      ...
      setError(message.includes("quota") || message.includes("Quota") ? "Die Website ist sehr gross. Der Scrape wurde verarbeitet, konnte aber nicht lokal gespeichert werden. Ich habe die Speicherung auf IndexedDB umgestellt; bitte nach dem Deployment erneut versuchen." : message);
