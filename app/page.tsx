...
import { Download, FileCode2, FolderTree, Github, Globe2, Loader2, Search } from "lucide-react";
...
export default function ScraperHome() {
  ...
  async function scrape() {
    setLoading(true); setError(""); setProject(null); setSelected("");
    try {
